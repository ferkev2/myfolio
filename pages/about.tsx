        ...
        <div className="grid">
          ...
          <div className="flex flex-col	justify-center w-3/4 place-self-center">
            ...
            <p className="p-2 mb-4">
              ...
              I worked for benext company in France, it&rsquo;s a company specialized in IT consulting and product management.
              The company has a lot a customer like Hermés, RadioFrance, Société Générale and others.
              I used to meet extraordinary people and learned a lot of them thanks to differents events organized by Benext.
              The company has a great expertise in agilty and product management.
              You can see all informations about Benext on the web page of the company.
            </p>
            <p className="p-2 mb-4">
              In another hand, I am a specialist in react technologies.
              I worked with Helmet, Easy Peasy, Redux and others. I made few talks about rxjs and web technologies.
              You cans see all my projects in the homepage of this website.
            </p>
            <p className="p-2 mb-4">
              About agility, I worked in project with Scrum method or Kamban. In differents project, I worked in feature teams.
            </p>
            <p className="p-2">
            ...
            <ul className="p-2 mb-6 flex flex-nowrap justify-center">
              ...
              <li className="m-2">
                <Image alt="angular-logo" src="/assets/stack/angular.png" width="150" height="150" />
              </li>
              <li className="m-2">
                <Image alt="js-logo" src="/assets/stack/javascript.png" width="150" height="150" />
              </li>
              <li className="m-2">
                <Image alt="html-logo" src="/assets/stack/html.png" width="150" height="150" />
              </li>
              <li className="m-2">
                <Image alt="css-logo" src="/assets/stack/css-logo.png" width="100" height="150" />
              </li>
              <li className="m-2">
                <Image alt="mongodb-logo" src="/assets/stack/mongodb-logo.png" width="150" height="150" />
              </li>
              <li className="m-2">
                <Image alt="postgresql-logo" src="/assets/stack/postgresql.png" width="250" height="150" />
              </li>
            </ul>
          </div>
        </div>
